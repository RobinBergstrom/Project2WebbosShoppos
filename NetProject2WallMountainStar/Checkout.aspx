                    ...
                    <table class="auto-styleCheckOut">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox_Zip" ErrorMessage="Enter a valid Zip-code" ForeColor="Red" ValidationExpression="\d{5}">*</asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td id="button_CancelOrder">
                                <asp:Button ID="Button_Cancel" CssClass="buttoncancel" runat="server" CausesValidation="False" Text="Cancel" OnClick="Button_Cancel_Click" />
                            </td>

                            <td id="button_SubmitOrder">
                                <asp:Button ID="Button_SubmitOrder" CssClass="buttonsubmit" runat="server" OnClick="Button_SubmitOrder_Click" Text="Submit order" />
                            </td>
                        </tr>
                    </table>
                </div>
